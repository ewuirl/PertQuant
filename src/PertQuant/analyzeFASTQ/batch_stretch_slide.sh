...
# folder_array=( "A-Bratio1-1" "A-Bratio1-1_z" \
#     "A-Bratio1-1_zCC" "A-Bratio1-2d" "A-Bratio1-2s" "A-Bratio1-4d" "A-Bratio1-4s" \
#     "A-Bratio1-4sv1"  "A-Bratio2-1sv1" "A-Bratio4-1sv1" )

folder_array=( "0-1ratio1-1_z" )

for folder in ${folder_array[@]}
do
    # Customize settings_file
    settings_file="/Users/emilywu/OneDrive - Massachusetts Institute of Technology/Minion/ExactBarcode/0-1ratio_settings.txt"
